<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DiscountedInvoice.aspx.cs" Inherits="DiscountedInvoice" %>
    ...
    <table>
        ...
        <tr>
         ...
         AutoGenerateEditButton="True"   BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" >
                         ...
                         <asp:BoundField DataField="low_Cost" HeaderText="Cost" ReadOnly="True" />
